...
i = 1
f = open('ettoday新聞摘要.txt', 'w', encoding='utf-8-sig', errors='ignore')
...
#製圖文字雲
text = open('ettoday新聞摘要.txt', "r",encoding="utf-8-sig").read()  #讀文字資料
...
#print(fon_path=font)
mask = np.array(Image.open("hp.jpg"))  #設定文字雲形狀 
...
wordcloud.to_file("hp_文字雲.png")  #存檔
